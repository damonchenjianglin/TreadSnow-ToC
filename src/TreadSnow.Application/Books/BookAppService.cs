...
[Authorize(TreadSnowPermissions.Books.Default)]
public class BookAppService : CrudAppService<Book, BookDto, Guid, PagedAndSortedResultRequestDto, CreateUpdateBookDto>, IBookAppService
{
    ...
    public BookAppService(IRepository<Book, Guid> repository, IAuthorRepository authorRepository) : base(repository)
    {
        ...
        GetPolicyName = TreadSnowPermissions.Books.Default;
        GetListPolicyName = TreadSnowPermissions.Books.Default;
        CreatePolicyName = TreadSnowPermissions.Books.Create;
        UpdatePolicyName = TreadSnowPermissions.Books.Edit;
        DeletePolicyName = TreadSnowPermissions.Books.Delete;
    }
